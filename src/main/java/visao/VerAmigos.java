 ...
 * @author josue
 */
public class VerAmigos extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerAmigos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
