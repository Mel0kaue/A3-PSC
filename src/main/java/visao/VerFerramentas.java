 ...
 * @author josue
 */
public class VerFerramentas extends javax.swing.JFrame {

    /**
     * Creates new form jFrmRelatórioFerramentas
     */
    public VerFerramentas() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String valor = this.jTableHistCompras.getValueAt(this.jTableHistCompras.getSelectedRow(), 3).toString().replace("R$ ", "");
        ...
        for (Ferramenta f: fdao.read()) {
            valorReal += Double.valueOf(f.getCusto());
        }
        
        this.txtTotalGasto.setText(valorReal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerFerramentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerFerramentas().setVisible(true);
            }
        });
    }
